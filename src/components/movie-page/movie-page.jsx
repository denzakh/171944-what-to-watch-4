    ...
    const getSimularGenreCardList = (simularGenreInMovieList) => {
      if (simularGenreMovieList.length) {
        return (<section className="catalog catalog--like-this">
          ...
          <CardList films={simularGenreInMovieList} setActiveItem={onActiveMoviePageChange} />
        </section>);
      } else {
        return null;
      }
                ...
                <div className="movie-card__wrap">
                  <div className="movie-card__desc">
                    ...
                    <div className="movie-card__buttons">
                      <button className="btn btn--play movie-card__button" type="button" onClick={this.handleOpenPlayer}>
              ...
              <div className="movie-card__wrap movie-card__translate-top">
                <div className="movie-card__info">
                  ...
                  <Tabs
                    ...
                    setActiveItem={this.handleTabClick}
                  >
                    {this.renderTab()}
                  </Tabs>
                </div>
